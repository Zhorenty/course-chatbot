  ...
  static GoogleSheetsDashboard build({
    ...
    styles.add(
      GoogleSheetsRangeStyle(
        startRow: dataStart,
        endRowExclusive: dataEnd,
        startColumn: CoursesSheet.headers.indexOf(CoursesSheet.isActive),
        endColumnExclusive: CoursesSheet.headers.indexOf(CoursesSheet.isActive) + 1,
        horizontalAlignment: 'CENTER',
        bold: true,
      ),
    );
    ...
    return GoogleSheetsDashboard(
      ...
      validations: <GoogleSheetsValidation>[
        ...
        GoogleSheetsValidation(
          startRow: dataStart,
          endRowExclusive: dataEnd,
          startColumn: CoursesSheet.headers.indexOf(CoursesSheet.productCode),
          endColumnExclusive: CoursesSheet.headers.indexOf(CoursesSheet.productCode) + 1,
          conditionType: 'ONE_OF_LIST',
          conditionValues: const <String>[CoursesSheet.seedProductCode],
          inputMessage: 'По умолчанию course. В боте не спрашиваем.',
        ),
        GoogleSheetsValidation(
          startRow: dataStart,
          endRowExclusive: dataEnd,
          startColumn: CoursesSheet.headers.indexOf(CoursesSheet.productTitle),
          endColumnExclusive: CoursesSheet.headers.indexOf(CoursesSheet.productTitle) + 1,
          conditionType: 'ONE_OF_LIST',
          conditionValues: const <String>[CoursesSheet.seedProductTitle],
          inputMessage: 'По умолчанию Курс. В боте не спрашиваем.',
        ),
        GoogleSheetsValidation(
          startRow: dataStart,
          endRowExclusive: dataEnd,
          ...
          conditionValues: const <String>[CoursesSheet.activeYes, CoursesSheet.activeNo],
          inputMessage: 'Флажок: ДА — текущий набор, НЕТ — нет.',
          showCustomUi: true,
        ),
        for (final column in dateColumns)
          GoogleSheetsValidation(
