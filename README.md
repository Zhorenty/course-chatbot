...
Старт бота и кнопка админа «Обновить Google Sheets» перечитывают `COURSES` в SQLite, затем обновляют `ВОРОНКА`. Пошагово: [`docs/DEPLOY.md`](docs/DEPLOY.md) → раздел Google Sheets.
