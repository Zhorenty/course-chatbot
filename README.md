...
- Вкладка **`COURSES`** (`gid=0`) — каталог запуска (цена, предоплата, даты). Её правят руками. Если лист пустой, бот один раз запишет текущие значения (18 000 ₽ / 5 000 ₽, доплата 05.10.2026, старт 12.10.2026).
