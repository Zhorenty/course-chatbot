...
3. Если ссылка не открылась — человек пишет админу; новую выдаёт **только админ из карточки** (старая отключается). Сам ученик новую не запрашивает.
...
- перевыдача одноразовой ссылки в канал из карточки;
...
**Одноразовые invite.** Бот — админ канала с правом приглашать. Новую ссылку выдаёт только админ из карточки.
...
- «Записаться» доступна до оплаты; после оплаты — «Мой курс» со статусом;
...
- новую ссылку в канал выдаёт только админ из карточки, ученик сам её не запрашивает;
