...
В каждом сообщении воронки (и в меню) доступна кнопка **«Записаться на курс»**. Прогрев не блокирует запись.

В сообщениях прогрева — кнопка **«Не писать»**. После отписки бот не шлёт прогрев; меню, гайд и запись остаются. Напоминания про уже начатую оплату / доплату отписка не глушит.
