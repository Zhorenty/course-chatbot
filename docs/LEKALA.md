...
7. Брошенная оплата: `checkout_started` и `awaiting_payment`, 6 ч и сутки; за 3 дня до старта — одно касание вместо 6ч/24ч. Invite без входа — 24 ч **или** к старту, не оба в одном тике; в письме текущая ссылка.
